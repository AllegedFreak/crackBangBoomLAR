                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/comics/{{ $comic->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $comic->title }}" min="0" step="1" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="illustrator" type="text" class="form-control{{ $errors->has('illustrator') ? ' is-invalid' : '' }}" name="illustrator" value="{{ $comic-> illustrator }}" min="0" step="1" autofocus>
