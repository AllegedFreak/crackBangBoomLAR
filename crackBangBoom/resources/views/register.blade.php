...
<div class="container-fluid contact-principal">
  ...
  <form class="contact-form form" action="register.php" method="post" id="register" enctype="multipart/form-data">
    ...
    <br>
    <input type="text" name="name" placeholder="Nombre y Apellido" autofocus value="<?php //echo $tempNombreCompleto ?>">
    <br>
    ...
    @if ($errors->has('paisnacimiento'))
        <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('paisnacimiento') }}</strong>
        </span>
    @endif
